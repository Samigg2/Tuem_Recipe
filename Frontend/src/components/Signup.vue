  ...
  >
    ...
    <div class="flex flex-col w-full relative justify-start items-center">
      <Input
        v-model="name"
        type="text"
        placeholder="Samuel Gebrekirstos"
        class="auth-input"
      />
      <span class="text-sm text-red-600">{{ nameError && nameError.toString() }}</span>
    </div>
    <div class="flex flex-col relative w-full justify-start items-center">
      <Input
        ...
        class="auth-input"
      />
      <span class="text-sm text-red-600">{{ emailError && emailError.toString() }}</span>
    </div>
