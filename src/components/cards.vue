    ...
    <div class="flex flex-col relative w-full bg-white h-36 pb-2 gap-2 items-start">
      ...
      <div class="flex flex-row justify-between w-full px-2">
        ...
        <div class="flex items-center gap-1">
          <ratecomponent :rating="rate" :numberOfRates="ratedby" />
          <span class="text-sm text-slate-400">({{ ratedby }})</span>
        </div>
      ...
      <!-- Comments and Duration Row -->
      <div class="flex flex-row justify-between w-full px-2">
        <div class="flex text-sm gap-[2px] items-center">
          <svg
            class="w-5 h-5 fill-slate-400"
            focusable="false"
            aria-hidden="true"
        ...
        <div class="flex text-sm text-slate-400 items-center">
          <svg
            class="w-5 h-5 fill-slate-300 mr-1"
            focusable="false"
            aria-hidden="true"
            viewBox="0 0 24 24"
